...
def load():
    # 硬编码 CSV 文件路径
    CSV_FILE_PATH = r'P:\xiangmu\python\Voice\train_new_001.csv'
...
def recognizeAudioPrint():
    # 配置化 CSV 文件路径
    CSV_FILE_PATH = r'P:\xiangmu\python\Voice\test_new_001.csv'
    ...
    file = open(r'P:\xiangmu\python\Voice\result_new_001.csv', 'w', newline='')
